        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>Aarti Kori</td>
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>art@gmail.com</td>
