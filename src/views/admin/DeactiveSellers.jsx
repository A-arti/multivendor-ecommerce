        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Diya Bala</td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>diya@gmail.com</td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
