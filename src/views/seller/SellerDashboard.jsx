  ...
  return (
    <div className='px-2 md:px-4  sm:px-8'>
      <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        ...
        <div className='flex justify-between items-center p-5 bg-[#ffffff] rounded-md gap-3'>
          <div className='flex flex-col justify-start items-start text-[#5c5a5a]'>
            <span className='text-md font-medium'>Buyers</span>
      ...
      <div className='w-full flex flex-wrap mt-4 '>
        ...
        <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
          <div className='w-full bg-[#ffffff] p-4 rounded-md text-[#333]'>
            <div className='flex justify-between items-center'>
              <h2 className='font-medium text-lg text-[#333] py-2'>Recent Chats</h2>
        ...
        {/*  */}
        <div className='w-full p-4 bg-[#ffffff] rounded-md mt-4 border'>
          <div className='flex justify-between items-center'>
